...
* [Desenvolvimento back-end](#desenvolvimento-back-end-hourglass_flowing_sand)
  - [Seção 1: Docker: Utilizando Containers](#seção-1-docker-utilizando-containers)
  - [Seção 2: Introdução à SQL](#seção-2-introdução-à-sql)
  - [Seção 3: Funções SQL, JOINs e Normalização](#seção-3-funções-sql-joins-e-normalização)
  - [Seção 4: Introdução ao desenvolvimento Web com Node.js](#seção-4-introdução-ao-desenvolvimento-web-com-nodejs)
  - [Seção 5: Arquitetura de Software: Model, Service e Controller](#seção-5-arquitetura-de-software-model-service-e-controller)
  - [Seção 6: Node.js: ORM e Autenticação](#seção-6-nodejs-orm-e-autenticação)
  - [Seção 7: Masterclass: Implementação de Aplicações na Nuvem](#seção-7-masterclass-implementação-de-aplicações-na-nuvem)
  - [Seção 8: Introdução a TypeScript](#seção-8-introdução-a-typescript)
  - [Seção 9: Programação Orinentada a Objeto (POO) e SOLID](#seção-9-programação-orinentada-a-objeto-poo-e-solid)
  - [Seção 10: Projeto - TFC - Trybe Futebol Clube](#seção-10-projeto---tfc---trybe-futebol-clube)
  - [Seção 11: Introdução ao MongoDB](#seção-11-introdução-ao-mongodb)
  - [Seção 12:  APIs OO e NoSQL](#seção-12--apis-oo-e-nosql)
  - [Seção 13: Projeto - App de Delivery](#seção-13-projeto---app-de-delivery)
  - [Seção 14: MasterClass - VPS, CI/CD](#seção-14-masterclass---vps-cicd)
...
- [x] 8-6: _[Projeto - Zoo functions](https://github.com/SamuelR499/zoo-functions)_
...
##### Seção 9: Programação Orinentada a Objeto (POO) e SOLID
...
- [ ] 10-1: _MongoDB - Introdução_
- [ ] 10-2: _Filter Operators_
- [ ] 10-3: _Operadores de consulta_
- [ ] 10-4: _Updates Simples_
- [ ] 10-5: _Updates Complexos - Arrays_
- [ ] 10-6: _[Projeto - Commerce]()_
