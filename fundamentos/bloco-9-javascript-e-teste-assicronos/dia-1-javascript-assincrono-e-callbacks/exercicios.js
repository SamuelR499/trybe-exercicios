...
//Solução: A ordem de finalização das linhas comentadas é: A , B e, por fim, C .
...
Solução: A ordem de finalização das linhas comentadas é: A , C e, por fim, B .
const planetDistanceFromSun = ({ name, distanceFromSun: { value, measurementUnit } }) =>
  `${name} is ${value} ${measurementUnit} apart from the Sun`;
...
// 4 - Crie a função sendMarsTemperature , que imprime a temperatura em Marte.
