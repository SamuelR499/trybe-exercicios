...
describe("testando implementações", () => {
  ...
  test("deve receber dois parâmetros e retornar a multipicação do primeiro pelo segundo. Essa implementação deve ocorrer uma única vez", () => {
  ...
  test("mockando função que recebe um parâmetro e retorna seu dobro", () => {
    ...
    expect(service.randomNumber(4)).not.toBe(9);
